...
export _LED6_GetState
export  LED6_GetState
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED6_Start(void)
;  FUNCTION NAME: LED6_Stop(void)
;
;  FUNCTION NAME: LED6_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(0)                                            ; Active High Digit Drive
   or   [Port_2_Data_SHADE],LED6_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_2_Data_SHADE],~LED6_PinMask
ENDIF
   jmp  .Switch_LED
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED6_Invert(void)
;
;  DESCRIPTION:
;     Invert state of LED                               
;
...
_LED6_Invert:
 LED6_Invert:
   ...
   xor  [Port_2_Data_SHADE],LED6_PinMask
   mov  A,[Port_2_Data_SHADE]
   mov  reg[LED6_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED6_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,LED6_PinMask                ; Mask off the trash
