...
;;  Version: 5.3, Updated on 2010/9/19 at 23:41:9
...
//	and  A,0x7F							//comes in as 1 start 7 bit and 2 stop bits
//	lcall _received_byte				//this will push it onto the fifo
//	pop  X
//	pop  A
   ;---------------------------------------------------
   ; Insert your custom code above this banner
