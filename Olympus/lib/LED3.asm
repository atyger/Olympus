...
export _LED3_GetState
export  LED3_GetState
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED3_Start(void)
;  FUNCTION NAME: LED3_Stop(void)
;
;  FUNCTION NAME: LED3_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(0)                                            ; Active High Digit Drive
   or   [Port_2_Data_SHADE],LED3_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_2_Data_SHADE],~LED3_PinMask
ENDIF
   jmp  .Switch_LED
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED3_Invert(void)
;
;  DESCRIPTION:
;     Invert state of LED                               
;
...
_LED3_Invert:
 LED3_Invert:
   ...
   xor  [Port_2_Data_SHADE],LED3_PinMask
   mov  A,[Port_2_Data_SHADE]
   mov  reg[LED3_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED3_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,LED3_PinMask                ; Mask off the trash
