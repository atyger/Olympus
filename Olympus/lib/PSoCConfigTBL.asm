...
export LoadConfigTBL_Olympus_Bank1
export LoadConfigTBL_Olympus_Bank0
export LoadConfigTBL_Olympus_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Olympus_Bank0:
;  Instance name E2PROM, User Module E2PROM
;  Instance name LED1, User Module LED
;  Instance name LED2, User Module LED
;  Instance name LED3, User Module LED
;  Instance name LED4, User Module LED
;  Instance name LED5, User Module LED
;  Instance name LED6, User Module LED
;  Instance name Timer8, User Module Timer8
;       Instance name Timer8, Block Name TIMER8(DBB00)
	db		23h, 04h		;Timer8_CONTROL_REG(DBB00CR0)
	db		21h, 18h		;Timer8_PERIOD_REG(DBB00DR1)
	db		22h, 00h		;Timer8_COMPARE_REG(DBB00DR2)
...
;  Global Register values Bank 0
	...
	db		b0h, fch		; Row_0_InputMux register (RDI0RI)
...
;  Instance name Timer8, User Module Timer8
;       Instance name Timer8, Block Name TIMER8(DBB00)
	db		20h, 20h		;Timer8_FUNC_REG(DBB00FN)
	db		21h, 16h		;Timer8_INPUT_REG(DBB00IN)
	db		22h, 40h		;Timer8_OUTPUT_REG(DBB00OU)
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB03)
...
;       Instance name UART, Block Name TX(DCB02)
	...
	db		2ah, 46h		;UART_TX_OUTPUT_REG (DCB02OU)
...
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[03h], 3fh		; Port_0_DriveMode_2 register (PRT0DM2)
	...
	M8C_SetBank1
	mov	reg[04h], d0h		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], 2fh		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], 0bh		; Port_1_DriveMode_2 register (PRT1DM2)
	mov	reg[06h], 60h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
