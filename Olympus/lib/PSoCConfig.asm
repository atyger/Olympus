...
export LoadConfig_Olympus
export _LoadConfig_Olympus
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Olympus
	lcall	LoadConfigTBL_Olympus_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Olympus
;
;    Load configuration registers for Olympus.
...
_LoadConfig_Olympus:
 LoadConfig_Olympus:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Olympus_Bank0
    mov     X, <LoadConfigTBL_Olympus_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Olympus_Bank1
    mov     X, <LoadConfigTBL_Olympus_Bank1
