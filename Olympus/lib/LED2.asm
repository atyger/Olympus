...
export _LED2_GetState
export  LED2_GetState
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_Start(void)
;  FUNCTION NAME: LED2_Stop(void)
;
;  FUNCTION NAME: LED2_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(0)                                            ; Active High Digit Drive
   or   [Port_2_Data_SHADE],LED2_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_2_Data_SHADE],~LED2_PinMask
ENDIF
   jmp  .Switch_LED
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_Invert(void)
;
;  DESCRIPTION:
;     Invert state of LED                               
;
...
_LED2_Invert:
 LED2_Invert:
   ...
   xor  [Port_2_Data_SHADE],LED2_PinMask
   mov  A,[Port_2_Data_SHADE]
   mov  reg[LED2_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,LED2_PinMask                ; Mask off the trash
